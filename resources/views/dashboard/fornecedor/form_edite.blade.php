                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show position-relative"
                        ...
                        <div id="pessoa_juridica"
                            ...
                            <div class="p-3 row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="razao_social" class="form-label fw-bold obrigatorio">Razão Social</label>
                            ...
                            <div class="p-3 row">
                                <div class="mb-3 col-md-3">
                                    <label for="indicador_inscricao_estadual" class="form-label fw-bold obrigatorio">Indicador de Inscrição Estadual</label>
                        ...
                        <div class="accordion-body">
                            <div class="box_contato_adicionais">
                                ...
                                <p class="text-center text-muted mensagem_sem_contato"
                                   @if( count($fornecedor->contato_adicionais)) style="display: none" @endIf >NÃO HÁ
                                ...
                                <div class="p-3 row">
                                    <div class="mb-3 col-md-3">
                                        <label for="condominio"
                                               class="form-label fw-bold obrigatorio">Condomínio?</label>
